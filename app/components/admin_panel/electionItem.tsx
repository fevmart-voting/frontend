...
import { Election, ElectionOption, VoteResultRow, ApiSuccess } from '../../api/api'
...
export default function ElectionItem({ election, fetchResults, fetchOptions, onAddOption, onUpdateStatus, onUpdateDates }: ElectionItemProps) {
